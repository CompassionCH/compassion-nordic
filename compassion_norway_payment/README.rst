...
.. |badge3| image:: https://img.shields.io/badge/github-CompassionCH%2Fcompassion--nordic-lightgray.png?logo=github
    :target: https://github.com/CompassionCH/compassion-nordic/tree/14.0
    :alt: CompassionCH/compassion-nordic

|badge1| |badge2| |badge3|

Import users and products
...
===========
Transmission Number <-> Payment Create Date

Data Transmitter <-> In payment Mode:  Initiating Party Identifier

Account <-> In bank journal: Account Number

payer_name <-> Partner Id Ref
