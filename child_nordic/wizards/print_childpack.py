...
class PrintChildpack(models.TransientModel):
    ...
    type = fields.Selection(
        [
            ("child_nordic.childpack_full", "Full Childpack"),
            ("child_nordic.childpack_small", "Small Childpack"),
        ],
    ...
    def _default_type(self):
        ...
        if child.sponsor_id:
            return "child_nordic.childpack_small"
        return "child_nordic.childpack_full"
