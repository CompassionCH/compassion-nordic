...
from .records import EndRecord, OpeningRecord, PaymentRecord
...
class PaymentInitiation:
    ...
    date_written: datetime.date = field(validator=instance_of(datetime.date))
    ...
    def _get_incoming_payment(records: list[R]) -> list["Payment"]:
        ...
        for record in records:
            if isinstance(record, PaymentRecord):
                ...
                raise ValueError("Record is not an Instance of Payment Record")
